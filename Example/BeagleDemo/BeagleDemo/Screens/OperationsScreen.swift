...
let operationsMenuScreen: Screen = {
    return Screen(navigationBar: NavigationBar(title: "Context Operations", showBackButton: true), child:
                    Container {
                        Button(
                            text: "Operations",
...
let operationsScreen: Screen = {
    return Screen(navigationBar: NavigationBar(title: "Operations", showBackButton: true), child:
...
let operationsWebSampleScreen: Screen = {
    return Screen(navigationBar: NavigationBar(title: "Operations Web Sample", showBackButton: true), child:
